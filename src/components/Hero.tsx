    ...
    >
      ...
      >
        ...
        <div className="max-w-4xl mx-auto z-10 relative">
          ...
          <p className="text-lg md:text-xl text-agency-dark/80 dark:text-white/80 mb-8 max-w-2xl mx-auto">
            Мы создаем сильные визуальные бренды, увеличиваем охваты и конвертируем подписчиков в клиентов 
            с помощью продуманных SMM-стратегий
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            <div className="bg-white/80 dark:bg-agency-dark/80 backdrop-blur-md p-4 rounded-lg shadow-sm animate-fade-in">
              <div className="text-3xl font-bold text-agency-accent mb-1">97%</div>
              <div className="text-sm text-agency-dark/70 dark:text-white/70">Довольных клиентов</div>
            </div>
            <div className="bg-white/80 dark:bg-agency-dark/80 backdrop-blur-md p-4 rounded-lg shadow-sm animate-fade-in [animation-delay:200ms]">
              <div className="text-3xl font-bold text-agency-accent mb-1">350+</div>
              <div className="text-sm text-agency-dark/70 dark:text-white/70">Успешных проектов</div>
            </div>
            <div className="bg-white/80 dark:bg-agency-dark/80 backdrop-blur-md p-4 rounded-lg shadow-sm animate-fade-in [animation-delay:400ms]">
              <div className="text-3xl font-bold text-agency-accent mb-1">5.4M</div>
              <div className="text-sm text-agency-dark/70 dark:text-white/70">Общий охват</div>
            </div>
            <div className="bg-white/80 dark:bg-agency-dark/80 backdrop-blur-md p-4 rounded-lg shadow-sm animate-fade-in [animation-delay:600ms]">
              <div className="text-3xl font-bold text-agency-accent mb-1">83%</div>
              <div className="text-sm text-agency-dark/70 dark:text-white/70">Рост продаж</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <HashLink smooth to="#about">
          <Icon name="ChevronDown" className="text-agency-dark/50 dark:text-white/50" size={32} />
        </HashLink>
      </div>
    </section>
  );
